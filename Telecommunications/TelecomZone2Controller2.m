classdef TelecomZone2Controller2 < handle
    ...
    methods
        ...
        function obj = TelecomZone2Controller2(...
                numberOfBuses, numberOfBranches, numberOfGen, numberOfBatt, telecomDelay)
            obj.delay = telecomDelay;
            blankStateQueue(1:telecomDelay) = StateOfZone(numberOfBranches, numberOfGen, numberOfBatt);
            obj.stateQueue = blankStateQueue;
            obj.disturbancePowerTransitQueue = zeros(numberOfBuses, telecomDelay);
        end
