...
%}
classdef MixedLogicalDynamicalMPC_PAunknown_DeltaPCreal_coefDeltaPA < Controller
    ...
    methods
        function obj = MixedLogicalDynamicalMPC_PAunknown_DeltaPCreal_coefDeltaPA(delayCurtailment, delayBattery, delayTelecom, ...
                horizonInIterations, ...
            ...
            obj.coefDeltaPA = coefficientDeltaPA;
        ...
        function decomposeState(obj, state)
            ...
            for g = 1:obj.numberOfGen
                ...
                if isPreviousGenerationLimitedByCurtailment && isCurrentGenerationLimitedByCurtailment
                    ...
                    obj.Delta_PA_est(g,1) = obj.coefDeltaPA * obj.maxPastDeltaPA(g,1);
                end
            end
